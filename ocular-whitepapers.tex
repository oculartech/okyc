...
Ocular is developing a compliance and onboarding ecosystem that leverages cutting edge technologies such as artificial intelligence(AI) and machine learning to satisfy compliance requirements at the highest possible levels.
...
A total of 25\% of minted tokens will be held in a growth fund to be used to incentivize users to participate in the OCULAR ecosystem, to reward early adopters and fund the integration of the Ocular platform with strategic partners.
\\
\\
